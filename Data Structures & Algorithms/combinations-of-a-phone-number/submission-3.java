class Solution {
    public List<String> letterCombinations(String digits) {
        ...
        backtrack(digits, 0, new StringBuilder(), res, m);
        return res;
    }

    public void backtrack(String digits, int index, StringBuilder sb, List<String> res, HashMap<Character, Set<Character>> m) {
        ...
        for(Character c: m.get(digit)) {
            ...
            sb.append(c);
            // backtrack
            backtrack(digits, index+1, sb, res, m);
            // undo choice
