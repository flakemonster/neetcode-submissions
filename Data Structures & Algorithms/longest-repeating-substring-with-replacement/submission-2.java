class Solution {
    public int characterReplacement(String s, int k) {
        ...
        while(l<s.length() && r<s.length()) {
            ...
            System.out.println(" countMap["+s.charAt(r)+"] "+countMap[s.charAt(r)-'A']);
            System.out.println("l "+l+" r "+r+" windowLen "+windowLen+" maxFreq "+maxFreq+" windowLen - maxFreq "+(windowLen - maxFreq));
